...
public class FourDirectionsFireStrategy implements FireStrategy {
    ...
    public void fire(Tank t) {
        ...
        t.gameModel.bullets.add(t.gameModel.factory.createBullet(bulletX, bulletY, Dir.UP, t.gameModel, t.group == Group.SELF ? Group.SELF : Group.ENEMY));

        // 右
        bulletHeight = ResourceMgr.bulletR.getHeight();
        bulletX = t.x + tankWidth + 5;
        bulletY = t.y + (tankHeight - bulletHeight) / 2;
        t.gameModel.bullets.add(t.gameModel.factory.createBullet(bulletX, bulletY, Dir.RIGHT, t.gameModel, t.group == Group.SELF ? Group.SELF : Group.ENEMY));

        // 下
        bulletWidth = ResourceMgr.bulletD.getWidth();
        bulletX = t.x + (tankWidth - bulletWidth) / 2;
        bulletY = t.y + tankHeight + 5;
        t.gameModel.bullets.add(t.gameModel.factory.createBullet(bulletX, bulletY, Dir.DOWN, t.gameModel, t.group == Group.SELF ? Group.SELF : Group.ENEMY));
