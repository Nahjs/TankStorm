...
public abstract class GameFactory {
     ...
     * @return
     */
    public abstract BaseTank createSelfTank(int x, int y, Dir dir, int speed, TankPanel tankPanel);

    /**
     * 创建敌方坦克
     * @return
     */
    public abstract BaseTank createEnemyTank(int x, int y, Dir dir, int speed, TankPanel tankPanel);

    /**
     * 创建子弹
     * @return
     */
    public abstract BaseBullet createBullet(int x, int y, Dir dir, TankPanel tankPanel, Group group);
